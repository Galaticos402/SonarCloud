                    ...
                    <tbody>
                        <c:forEach items="${ACCOUNT_LIST}" var="userDto" varStatus="counter">
                            <tr>
                                ...
                                <td>${userDto.email}</td>    
                                <td>
                                    <c:if test="${userDto.status}"><span class="update-link-true" onclick="changeStatus('${userDto.email}', '${userDto.status}')">True</span></c:if>
                                    <c:if test="${!userDto.status}"><span class="update-link-false" onclick="changeStatus('${userDto.email}', '${userDto.status}')">False</span></c:if>
                                </td>
                                <td>
                                    ${userDto.role.name}
                                </td>
