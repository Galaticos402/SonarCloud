            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <c:if test="${not empty user}">
                        <a href="Cart.jsp" ><div class="list-group-item btn card-header bg-primary text-white text-uppercase">View my Cart<sup>${sessionScope.productList.size()}</sup></div></a>
                ...
                <c:if test="${empty searchValue}">
                    ...
                    <c:if test="${empty requestScope.PRODUCT_LIST}">
                        <c:set var="productList" value="${requestScope.ALL_AVAILABLE_PRODUCT_LIST}"/>
                    </c:if>
                </c:if>
                <div class="col-sm-10">
                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="margin: auto;">
                                                    ...
                                                    <c:if test="${productDto.status}">
                                                        <p><a href="Cart?id=${productDto.id}&jspPage=Home" ><button class="btn btn-success btn-block">Add to cart</button></a></p>
                                                    </c:if>
                                                    <c:if test="${!productDto.status}">
                                                        <p><a href="Cart?id=${productDto.id}&jspPage=Home" ><button class="btn btn-success btn-block" disabled>Add to cart</button></a></p>
                                                    </c:if>
                                                    </c:if>
