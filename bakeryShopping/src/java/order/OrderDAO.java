...
public class OrderDAO implements Serializable {
 ...
 /*-----------------------------------------------------------------------------*/
    ...
    public void getPendingOrder() throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                //2. Create SQL String 
                String sql = "SELECT [Order].id, CustomerEmail, [User].Address, [User].PhoneNumber, [User].FullName, [Order].Status, SaleEmail, CompleteDate, TotalOrderPrice "
                ...
                while (rs.next()) {
                    ...
                    OrderSaleDTO dto = new OrderSaleDTO(address, phoneNumber, fullname, id, customerEmail, status, saleEmail, completeDate, total);
 ...
 /*----------------------------------------------------------------------------*/
    ...
    /*Create Order*/
 /*----------------------------------------------------------------------------*/
    public boolean createOrder(OrderDTO order, List<OrderItemDTO> items) {
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            // Insert an order instance
            String sql = "INSERT INTO [Order](CustomerEmail, Status, SaleEmail,CompleteDate,TotalOrderPrice) VALUES (?,?,?,?,?)";
    ...
    public List<HashMap<String, String>> getOrderHistoryByUserEmail(String email) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                temp.put("totalOrderPrice", String.valueOf(rs.getInt("TotalOrderPrice")));
                temp.put("orderId", String.valueOf(rs.getInt("Id")));
