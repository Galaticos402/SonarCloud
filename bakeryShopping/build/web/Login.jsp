    ...
    <body>
        ...
        <div id="logreg-forms">
            <form class="form-signin" action="login" method="post">
                ...
                <input name="txtEmail"  type="text" id="inputEmail" class="form-control" placeholder="Username" value="${requestScope.EMAIL}" required="" autofocus="">
                <input name="txtPassword"  type="password" id="inputPassword" class="form-control" placeholder="Password" value="${requestScope.PASSWORD}" required="">
