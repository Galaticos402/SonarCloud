                        ...
                        <form action="addAccount" id="addAccountForm">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input value="${accountDto.email.trim()}" name="txtAccEmail" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input value="${accountDto.password.trim()}" name="txtAccPassword" type="text" class="form-control" id="txtAccPassword">
                                </div>
                                <div class="form-group">
                                    <label>Confirm Password</label>
                                    <input value="${accountDto.password.trim()}" name="txtAccConfirmPassword" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>Full Name</label>
                                    <input value="${accountDto.fullName.trim()}" name="txtAccFullName" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                    ...
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input value="${accountDto.address.trim()}" name="txtAccAddress" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Phone Number</label>
                                    <input value="${accountDto.phoneNumber.trim()}" name="txtAccPhoneNumber" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Role</label>
